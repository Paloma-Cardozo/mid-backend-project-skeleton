...
INSERT INTO cart_item (cart_id, event_id, quantity, price_snapshot)
VALUES
  (1, 1, 2, 950.00),
  (1, 3, 1, 300.00);

INSERT INTO customer_order (user_id, total_amount)
VALUES (1, 800.00);

INSERT INTO order_item (order_id, event_id, quantity, price_snapshot)
VALUES (1, 4, 1, 800.00);